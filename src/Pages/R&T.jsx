    ...
    return(
        <div className="pages-element-1">
            ...
            <div className="page-container-1" style={{marginBottom:"2rem"}}>
                ...
                <p>Road safety measures encompass a wide range of interventions aimed at improving the safety of road users, including motorists, pedestrians, cyclists, and passengers. These measures address various factors contributing to road accidents, such as speeding, impaired driving, distracted driving, and inadequate road infrastructure.
